...
/**
  ...
  */
static uint8_t __check_if_the_bits_match(key_value_type_t* state_bits, key_value_type_t target,
...
void button_handler(struct button_obj_t* button)
{
    ...
    if (read_gpio_level != button->read_level)
    {
