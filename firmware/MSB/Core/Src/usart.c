...
void MX_UART4_Init(void)
{
  ...
  huart4.Init.ClockPrescaler = UART_PRESCALER_DIV10;
...
void MX_UART8_Init(void)
{
  ...
  if (HAL_UARTEx_SetTxFifoThreshold(&huart8, UART_TXFIFO_THRESHOLD_1_2) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_UARTEx_SetRxFifoThreshold(&huart8, UART_RXFIFO_THRESHOLD_1_2) != HAL_OK)
  {
    Error_Handler();
  }
